document.addEventListener('DOMContentLoaded', function() {
    ...
    const packs = {
        expansions: [
            ...
            { name: "Seasons", options: [{ name: "Gardener", type: "job" }, { name: "Flower Arranging", type: "skill" }, { name: "Scout", type: "job" }, { name: "Decor Box Rummage", type: "skill" }, { name: "Harvest and Sell Honey", type: "skill" }] },
